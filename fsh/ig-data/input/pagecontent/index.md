...
| `responseMessageNum`  | OPTIONAL     | INT    | If more than one responses will be sent, specifies the sequence order of each response. |
| `responseFinal`       | OPTIONAL     | BOOL   | True when the message is the final response to a request. |
